function mean_NN_MonteCarlo_3D_pdist_LaVision(area_dir, F_XYZIDint, threshold, trial_number, resolution, out_dir)
...
for t=1:trial_number
        ...
        random_points_space = [resolution(1) * x resolution(2) * y resolution(3) * z];
...
%% Calculation of the mean NN value of actual data
        ...
        data_points_space = [resolution(1) * x resolution(2) * y resolution(3) * z]; % Resolution
...
%% Save data
        ...
        Header ={'Data_Mean_distance', 'Simulation_Mean_distance', 'Simulation_Standard_deviation', ...
                 'Point_number', 'Trial_number', 'NN_index', ...
                 'Hypothesis', 'p_value', 'Confidence_interval1', 'Confidence_interval2','z_value'};
